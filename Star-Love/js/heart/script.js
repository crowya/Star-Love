...
const shorterDimension = Math.min(window.innerWidth, window.innerHeight);
renderer.setSize(shorterDimension, shorterDimension);
document.body.prepend(renderer.domElement);
document.body.firstElementChild.setAttribute("id","heart");
